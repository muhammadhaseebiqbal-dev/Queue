        ...
        <div className="w-[85%] bg-secondary rounded-2xl p-5 mb-3 border border-border">
            ...
            <div className="flex items-center gap-2 mb-5 pb-4 border-b border-border">
                ...
                <div className="flex-1">
                    <h3 className="text-sm font-medium text-text">DeepMind Analysis</h3>
                    <p className="text-xs text-textLight">Multi-model consensus processing • This may take 2-3 minutes</p>
                </div>
            </div>
